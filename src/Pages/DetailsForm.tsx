      ...
      <form>
        <div className=" w-5/6 min-h-[423px] mb-10 py-5 bg-baform shadow-shadowEmp rounded-[20px] m-auto mt-10">
          ...
          <div className="grid xl:grid-cols-3  lg:grid-cols-2 grid-cols-1 px-10 pt-10 mb-5">
            ...
            <div>
              ...
              <input type="text" {...register("age")} className="border-[1px]  border-yellowAcc bg-transparent md:w-[330px] rounded-input h-[50px]" />
            ...
            <div>
              ...
              <input {...register("address")} className="border-[1px] border-yellowAcc bg-transparent md:w-[330px] rounded-input h-[50px]" />
            </div>
            {/* phone input  */}
            {/* <div>
              <label className="block font-roboto my-2 text-[20px] text-greenAcc">
        ...
        <div className="w-5/6 mt-5 px-10 py-10 m-auto">
          <p className="font-tinos text-[26px] font-bold">
            I, the undersigned, declare that all the data shown above, as well
            as the documents provided , are correct and conform to the
            situation, and I have not obtained a valid or renewable passport at
            the present time.
          </p>
        </div>
