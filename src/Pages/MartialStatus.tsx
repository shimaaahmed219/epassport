            ...
            <div className="bg-baform flex flex-col   shadow-shadowEmp w-6/6 pl-6 pt-10 pb-[55px] mx-20 min-h-[520px] rounded-[20px] m-auto my-10">
                ...
                <form>
                    ...
                    <Box className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-5/6  m-auto  justify-around lg:gap-x-[13rem] font-medium  font-roboto text-xl pt-7 pb-5  '>
                        <FormControlLabel control={<Checkbox icon={<RadioButtonUncheckedIcon></RadioButtonUncheckedIcon>} checkedIcon={< CheckCircleIcon></CheckCircleIcon>} style={{ color: '#F6C90E' }} />} label="Under 16 years old" className='' />
                        <FormControlLabel control={<Checkbox icon={<RadioButtonUncheckedIcon></RadioButtonUncheckedIcon>} checkedIcon={< CheckCircleIcon></CheckCircleIcon>} style={{ color: '#F6C90E' }} />} label="Married" className="lg:pl-20" />
                        <FormControlLabel control={<Checkbox icon={<RadioButtonUncheckedIcon></RadioButtonUncheckedIcon>} checkedIcon={< CheckCircleIcon></CheckCircleIcon>} style={{ color: '#F6C90E' }} />} label="Unmarried" className="lg:pl-20" />
                    </Box>


                    <div className="px-[100px]">
                        <label className="text-greenAcc font-roboto my-3 text-xl font-medium block">Husband name /</label>
                        <input type="text" className=" focus:outline-none px-5 text-lg text-hreenAcc rounded-input bg-transparent w-full h-[50px] border-[1px] border-yellowAcc" />
