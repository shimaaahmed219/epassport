...
export default function LandingFut() {
  return (
    <div className="w-full bg-white text-greenAcc mt-5 mb-[100px] ">
      ...
      {/* content  */}
      <div className="w-5/6 m-auto bg-black grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 justify-between items-center">
        {/*   Encryption technology. */}
        <div className="xl:w-[326px] md:w-[400px] h-[146px] xl:my-0 lg:my-10 my-5 bg-bg rounded-[20px] px-[20px] pt-[20px]">
          {/* icon */}
        ...
        {/* Ease of use.  */}
        <div className="xl:w-[326px] md:w-[400px] h-[146px] lg:m-auto md:m-auto xl:my-0 lg:my-10 my-5 bg-bg rounded-[20px] px-[20px] pt-[20px]">
          {/* icon */}
        ...
        {/* ******************************************* */}
        <div className="xl:w-[326px] md:w-[400px] h-[146px] xl:ml-0 md:ml-[290px] ml-0 lg:ms md:ms-auto xl:my-0 lg:my-10 my-5 bg-bg rounded-[20px] px-[20px] pt-[20px]">
          {/* icon */}
