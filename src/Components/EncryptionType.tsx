      ...
      <form className='w-[100%] h-full'>
        <div className='flex w-[100%] justify-between  '>
          ...
          <div className='w-[50%] flex flex-row rounded-input border-white border-4 relative '>
            <select className={`font-tinos  focus:outline-none select appearance-none px-5  rounded-input text-2xl w-[100%]  h-[3.75rem] bg-greenAcc appearanse-none text-white `}>
        ...
        <div className="w-5/6 m-auto h-[18rem] grid  mt-[5.5rem]">
          ...
          />
          <h1 className={`font-tinos text-center text-[32px] px-[140px]`}>
            Upload a file from the authorities or drag the file here
          </h1>
        </div>
        <div className="flex justify-center mb-[3rem]">
          <button className={` font-tinos w-[262px] h-[60px]  text-2xl text-center  shadow-4xl rounded-input text-white bg-greenAcc mt-[5.5rem] m-auto`}>Encryption</button>
        </div>
      </form>
    </div>
  )
