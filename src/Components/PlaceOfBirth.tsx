  ...
  return (
    ...
    <div className='px-10 mt-5  font-roboto  items-center text-[20px] text-greenAcc'>
        ...
        <div className='items-center flex'>
            <input {...register("address")} type="text" className=' rounded-input  w-[320px] h-50px border-[1px] border-yellowAcc px-[20px] py-[6px]' />
            <span className='font-roboto text-[40px] mx-10 '>/</span>
            <input {...register("governorate")} type="text" className=' rounded-input  w-[320px] h-50px border-[1px] border-yellowAcc px-[20px] py-[6px]' />
        </div>
    ...
    <div className=' my-7 font-roboto ml-5 items-center text-[20px] text-greenAcc'>
        ...
        <div className='items-center flex'>
            <input  {...register("religion")} type="text" className=' rounded-input  w-[276px] h-50px border-[1px] border-yellowAcc  pl-[20px] py-[6px]' />
