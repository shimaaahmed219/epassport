  ...
  return (
    <div className="w-full px-20">
      <div className="flex">
        ...
        <div className="w-1/6 mt-5 ml-10 ">
          <img src={img} alt="" />
        </div>

        <div className="text-center mt-20">
          <h3 className={`font-tions font-bold px-[14rem]`}>
      ...
      <form className="w-full ">
        ...
        <div className="w-[158px] h-[207px] bg-fileUploud ms-auto mt-[-9rem]   ">
          <input type="file" className="opacity-0 w-[6/6] h-[100%] z-50" />
        ...
        <div className="w-[100%] mt-10 min-h-screen bg-white rounded-[30px] p-10 shadow-shadowEmp">
          ...
          <div className="px-10 flex flex-row justify-between">
            ...
            {/* date */}
            <div className="gap-x-6 flex items-center font-roboto text-[22px] text-greenAcc ">
